                        ...
                        child: Column(
                          ...
                          children: [
                            FormBuilderTextField(
                              ...
                              initialValue: client.largestClassSize?.toString(),
                              decoration: const InputDecoration(
                                ...
                                onPressed: () async {
                                  if (formKey.currentState!.saveAndValidate()) {
                                    ...
                                    final String town = formKey
                                        .currentState!.fields['town']!.value;
                                    final String county = formKey
                                        .currentState!.fields['county']!.value;
                                    final String eircode = formKey
                                        .currentState!.fields['eircode']!.value;
                                    ...
                                    final int students = int.parse(formKey
                                        ...
                                        .fields['students']!
                                        .value);
                                    final DateTime joinDate = DateTime.parse(
                                        formKey.currentState!
                                            .fields['joinDate']!.value);
                                    final bool? hasHall = formKey
                                        .currentState!.fields['hasHall']!.value;
                                    final bool? isDeis = formKey
                                        .currentState!.fields['isDeis']!.value;
                                    final bool? hasParking = formKey
                                        .currentState!
                                        .fields['hasParking']!
                                        .value;
                                    final bool? hasMats = formKey.currentState!
                                        .fields['hasMats']!.value as bool?;
                                    ...
                                    final String? principalEmail = formKey
                                        ...
                                        .value as String?;
                                    final String? notes = formKey.currentState!
                                        .fields['notes']!.value as String?;
