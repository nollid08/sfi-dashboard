              ...
              ? Column(
                  children: [
                    ListTile(
                      ...
                      subtitle: Text(bookingWithSessions.client.contactPhone!),
                    ),
                    const Divider(),
                  ],
                )
              ...
              ? Column(
                  children: [
                    ListTile(
                      ...
                      subtitle: Text(bookingWithSessions.client.contactEmail!),
                    ),
                    const Divider(),
                  ],
                )
              ...
              ? Column(
                  children: [
                    ListTile(
                      ...
                      subtitle: Text(
                        bookingWithSessions.client.largestClassSize.toString(),
                      ),
                    ),
                    const Divider(),
                  ],
              ...
              ? Column(
                  children: [
                    ListTile(
                      ...
                      subtitle: Text(bookingWithSessions.client.principalName!),
                    ),
                    const Divider(),
                  ],
                )
