...
class AddNewCoachesToSingleSessionsDialog extends ConsumerStatefulWidget {
  const AddNewCoachesToSingleSessionsDialog({
    super.key,
  ...
  @override
  ConsumerState<AddNewCoachesToSingleSessionsDialog> createState() =>
      _AddNewCoachesToBookingDialogState();
}

class _AddNewCoachesToBookingDialogState
    extends ConsumerState<AddNewCoachesToSingleSessionsDialog> {
  final List<CoachRecommendation> selectedCoaches = [];
  @override
  Widget build(BuildContext context) {
    final suitableCoaches =
        ref.watch(findSessionsAvailableCoachesProvider(widget.session));
    final bool actionsEnabled =
        selectedCoaches.isNotEmpty && suitableCoaches.hasValue;
    return AlertDialog(
      title: const Text(
        'Add New Coaches To Single Session',
      ),
        ...
        FilledButton(
          onPressed: actionsEnabled
              ? () {
                  ...
                  sessionsNotifier.addCoachesToSession(
              ...
              : null,
          child: Text(
            'Add ${selectedCoaches.length} Coaches To This Session Only',
          ),
        ),
      ],
    );
